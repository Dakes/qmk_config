 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
 * | TAB    | Q      | W      | F      | R->Z   | Z->B   | 7      | 8      | 9      | J      | U      | I      | O      | P      | Ü/AltGr|
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | LSHIFT | A/SHFT |S->R/GUI|D->S/ALT| T/STRG | G      | 4      | 5      | 6      | H      | N/STRG | E/ALT  | L/GUI  | Ö/SHFT | Ä/SHFT |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | STRG   | Y      | X      | C      | V->D   | B->V   | 1      | 2      | 3      | K      | M      | ,      | .      | UP     |-_/STRG |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | SYM LAY|NEXTSONG| PLAY/P.| GUI    | ALT    | SPACE  | ESC    | 0      | ENTER  | SPACE  | BACKSP | DEL    | LEFT   | DOWN   | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
    ...
    KC_LSFT,  LSFT_T(KC_A), LGUI_T(KC_R), LALT_T(KC_D), LCTL_T(KC_T),   LT(_NAV_NUM, KC_G),  KC_4,                  KC_5,            KC_6,              LT(_NAV_NUM, KC_H),   LCTL_T(KC_N),   LALT_T(KC_E), LGUI_T(KC_L), RSFT_T(DE_ODIA), RSFT_T(DE_ADIA), \
 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | STRG   | Z      | X      | C      | V      | B      | 1      | 2      | 3      | N      | M      | ,      | .      | UP     |-_/STRG |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | SYM LAY|NEXTSONG| PLAY/P.| GUI    | ALT    | SPACE  | ESC    | 0      | ENTER  | SPACE  | BACKSP | DEL    | LEFT   | DOWN   | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
...
/* GAMING
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 * | ESC    | 1      | 2      | 3      | 4      | 5      | 6      | 7      | 8      | 9      | 0      | F11    | F12    | ß      | Backsp |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
 * | TAB    | Q      | W      | E      | R      | T      | F7     | F8     | F9     | Y      | U      | I      | O      | P      | Ü/AltGr|
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | LSHIFT | A      | S      | D      | F      | G      | F4     | F5     | F6     | H      | J      | K      | L      | Ö      | Ä/SHFT |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | STRG   | Z      | X      | C      | V      | B      | F1     | F2     | F3     | N      | M      | ,      | .      | UP     |-_/STRG |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | STRG   |NEXTSONG| PLAY/P.| GUI    | SPACE  | SPACE  | SPACE  | 0      | ENTER  | SPACE  | BACKSP | DEL    | LEFT   | DOWN   | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
    [_GAMING] = LAYOUT_ortho_5x15(
    KC_ESC,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,            KC_8,              KC_9,                  KC_0,    KC_F11,  KC_F12,  DE_SS,   KC_BSPC,  \
    KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_F7,   KC_F8,           KC_F9,             DE_Y,                  KC_U,    KC_I,    KC_O,    KC_P,    ALGR_T(DE_UDIA), \
    KC_LSFT,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_F4,   KC_F5,           KC_F6,             KC_H,                  KC_J,    KC_K,    KC_L,    DE_ODIA, RSFT_T(DE_ADIA), \
    KC_LCTRL, DE_Y,    KC_X,    KC_C,    KC_V,    KC_B,    KC_F1,   KC_F2,           KC_F3,             KC_N,                  KC_M,    KC_COMM, KC_DOT,  KC_UP,   RCTL_T(DE_MINS), \
    KC_LCTRL, KC_MNXT, KC_MPLY, KC_LGUI, KC_LALT, KC_SPC,  KC_ENT,  LT(_FUNC, KC_0), LT(_SYM, KC_ENT),  LT(_NAV_NUM, KC_SPC),  KC_BSPC, KC_DEL,  KC_LEFT, KC_DOWN, KC_RIGHT  \
    ),
